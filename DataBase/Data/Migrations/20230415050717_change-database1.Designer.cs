...
namespace Database.Data.Migrations
{
    ...
    [Migration("20230415050717_change-database1")]
    partial class changedatabase1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Model.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Database.Model.ApplicationRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Database.Model.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Database.Model.ApplicationUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Database.Model.ApplicationUserLogin", b =>
                {
            ...
            modelBuilder.Entity("Database.Model.ApplicationUserRole", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Database.Model.ApplicationUserToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Database.Model.ApplicationRoleClaim", b =>
                {
                    b.HasOne("Database.Model.ApplicationRole", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("Database.Model.ApplicationUserClaim", b =>
                {
                    b.HasOne("Database.Model.ApplicationUser", "User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Database.Models.Discount", b =>
                {
                    b.HasOne("Database.Model.ApplicationUser", "Creator")
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("Database.Models.InvoiceReservation", b =>
                {
                    b.HasOne("Database.Model.ApplicationUser", "Confirmer")
